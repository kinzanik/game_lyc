...
def run():
    class SNAKE:
        def __init__(self):
            ...
            self.body_tr = pygame.image.load('body_tr.png')
            self.body_tl = pygame.image.load('body_tl.png')
            self.body_br = pygame.image.load('body_br.png')
            self.body_bl = pygame.image.load('body_bl.png')
